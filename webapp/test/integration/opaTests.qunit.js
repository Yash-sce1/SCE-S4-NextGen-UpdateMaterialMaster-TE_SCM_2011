...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/sce/materialmaster/test/integration/FirstJourney",
    "com/sce/materialmaster/test/integration/PDTProposalListJourney",
    "com/sce/materialmaster/test/integration/PDTProposalObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
